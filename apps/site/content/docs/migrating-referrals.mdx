...
description: Backfill customers, referral codes, relationships, and historical conversions from a legacy referral table into OfferKit without issuing rewards twice.
---
