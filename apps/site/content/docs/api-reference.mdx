---
title: API reference
description: Explore OfferKit REST and RPC routes, request and response types, authentication requirements, and schemas generated from the live oRPC contract.
---
