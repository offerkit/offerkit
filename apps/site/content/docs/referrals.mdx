---
title: Referrals
description: Integrate refer-a-friend into checkout, list each customer's referral codes, convert successful referrals idempotently, and issue rewards safely.
---
