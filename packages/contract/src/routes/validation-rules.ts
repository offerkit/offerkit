...
export const validationRules = {
  ...
  get: oc
    .route({ method: "GET", path: "/validation-rules/{id}", summary: "Get validation rule" })
  ...
  create: oc
    ...
    .output(validationRuleOutput),
  update: oc
    .route({ method: "PATCH", path: "/validation-rules/{id}", summary: "Update validation rule" })
    .input(z.object({ id: z.string().uuid(), patch: validationRuleUpdateInput }))
    .output(validationRuleOutput),
  delete: oc
    .route({ method: "DELETE", path: "/validation-rules/{id}", summary: "Soft-delete validation rule" })
    .input(z.object({ id: z.string().uuid() }))
